...
class UserModel extends Model {
     ...
     *
     * This private static function securely hashes a user password using the bcrypt algorithm
     * with a cost factor of 12. It enhances password security by applying a one-way hash function.
     * The function is typically used during user registration or password update processes.
     *
     * @param string $password The plaintext password to be hashed.
     *
     * @return string The hashed password generated by the bcrypt algorithm.
     */
