    ...
    <div class="container border my-3 p-3">
        <form action="admin.service.update.php" method="post">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" name="service_price" id="service_price" placeholder="Price" value="<?php echo $service['service_price'] ?>" />
            </div>
            <div class="mb-3">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="service_status" id="servie_status" value="active" <?php if ($service['service_status'] == 'active') {
                                                                                                                                echo 'checked';
                                                                                                                            } ?> />
                    <label class="form-check-label" for="">active</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="service_status" id="inactive" value="inactive" <?php if ($service['service_status'] == 'inactive') {
                                                                                                                            echo 'checked';
                                                                                                                        } ?> />
